  ...
  .then(async () => {
    ...
    server.use(
      OpenApiValidator.middleware({
        ...
        ignorePaths:
          /scan-now|qbittorrent-seeding|retention|stream|queue|watch-status|storage-reclaim|watched|liked|storage|recommendations|smart-recommendations|profiles|switch-profile|trailer|resume|avatar/,
      })
    );
    /**
