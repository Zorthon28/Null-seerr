  ...
  .then(async () => {
    ...
    server.use(
      OpenApiValidator.middleware({
        ...
        ignorePaths:
          /scan-now|qbittorrent-seeding|retention|stream|queue|watch-status|storage-reclaim|watched|storage|recommendations|smart-recommendations|profiles|switch-profile|trailer/,
      })
    );
    /**
